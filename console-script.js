...
async function startScan() {
    ...
    if (orderListJson.length > 0 && orderListJson.length === arrMyPriceLink.length) {
        for (let orderKey = 0; orderKey < orderListJson.length; orderKey++) {
            ...
            console.log(priceJSON.sell_order_graph[0][0]);
            console.log(priceJSON.buy_order_graph[0][0]);
...
function InterVal(JSONsell_order_graph ,JSONbuy_order_graph, buyOrderId, MyBuyOrderPrice) {  
    ...
    div.style.cssText = Color(JSONbuy_order_graph, MyBuyOrderPrice, actualProfit, coefPrice);
...
function Color (JSONbuy_order_graph, MyBuyOrderPrice, actualProfit, coefPrice) {
    ...
    }else if(JSONbuy_order_graph[0][0] != MyBuyOrderPrice  && MyBuyOrderPrice >= coefPrice){
